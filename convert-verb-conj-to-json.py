...
#with open("dicts/verbs-conjugations-test.csv", encoding="utf-8") as csv_file:
with open("dicts/verbs-conjugations.csv") as csv_file:
...
with open("dicts/verbs-conj-to-inf.js", "w", encoding="utf-8") as out_file:
  out_file.write(out_str)

# as pure JSON
#with open("dicts/verbs-conj-to-inf.json", "w", encoding="utf-8") as out_file:
